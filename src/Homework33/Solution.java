...
public class Solution {
	static void plus() {
		...
		System.err.println("Sonuç : " + result);
	}
	...
	static void mod() {
		...
		System.out.println("Hangi sayıya göre modu alnıncak sayıyı giriniz :");
		int modNumber = scan.nextInt();
		System.err.println("Sonuç :" + number % modNumber);
	}
	...
	static void calculateAreaOfRectangle() {
		...
		System.err.println("Dikdörtgenin alanı :" + longEdge * shortEdge);
		System.err.println("Dikdörtgenin çevresi :" + 2 * (longEdge + shortEdge));
	}
